    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 font-medium mt-4">Create your new password.</p>
        </div>

        <div className="glass-card shadow-2xl shadow-primary/5 p-10 border-white/50">
          <h2 className="text-3xl font-bold text-primary mb-8 text-center tracking-tight">New Password</h2>
          ...
          {isSuccess ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-500 font-medium">Your password has been reset successfully.</p>
              <p className="text-sm text-primary font-bold mt-6">Redirecting to login...</p>
            </div>
          ) : (
            <form onSubmit={handleUpdatePassword} className="space-y-6">
              <div className="space-y-2">
                <label className="text-sm font-bold text-primary/60 uppercase tracking-widest block ml-1">New Password</label>
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-primary/60 uppercase tracking-widest block ml-1">Confirm Password</label>
                <div className="relative">
                  <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" size={18} />
                  <input 
                    type="password" 
